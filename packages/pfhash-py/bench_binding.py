"""Benchmark the raw `pfhash._native` extension surface — same workload as
...
Run (from repo root):
    ...
    uv run python packages/pfhash-py/bench_binding.py > docs/benchmarks/binding.ndjson
"""
...
import numpy as np
from pfhash import _native as m
