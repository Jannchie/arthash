...
R&D playground for arthash. Everything here is exploratory — code shape isn't
stable, APIs break freely, and outputs feed into design decisions for
[`@arthash/py`](../arthash-py/) and the SPEC.
...
When a research experiment stabilizes it graduates to `@arthash/py` proper;
...
│   ├── baselines.py       thash / arthash / blurhash wrappers
